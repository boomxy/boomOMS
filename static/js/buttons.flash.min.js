...
!(function (a) {
  ...
  (f.Client.prototype = {
    ...
    (f.hasFlash = function () {
      try {
        ...
        if (
          navigator.mimeTypes &&
          navigator.mimeTypes["application/x-shockwave-flash"] !== d &&
  ...
  var g = function (a, b) {
    ...
    i = function (a) {
      var b = "Sheet1";
      return (
        a.sheetName && (b = a.sheetName.replace(/[\[\]\*\/\\\?\:]/g, "")), b
      );
    },
    j = function (b) {
      var c = b.title;
  ...
  return (
    (e.Buttons.swfPath = "/static/swf/flashExport.swf"),
